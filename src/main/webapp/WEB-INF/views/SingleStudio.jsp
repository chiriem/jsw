...
<%--&lt;%&ndash;        var playlist = 'CuklIb9d3fI';&ndash;%&gt;--%>
<%--&lt;%&ndash;        //https://www.youtube.com/watch?v=유튜브 영상 고유번호&ndash;%&gt;--%>
<%--&lt;%&ndash;        //playlist만 원하는 재생목록에 따라 가져오면 됨&ndash;%&gt;--%>

<%--&lt;%&ndash;        //maxResult는 50 이하&ndash;%&gt;--%>
<%--&lt;%&ndash;        $(document).ready(function () {&ndash;%&gt;--%>
<%--&lt;%&ndash;            $.get(&ndash;%&gt;--%>
<%--&lt;%&ndash;                "https://www.googleapis.com/youtube/v3/videos", {&ndash;%&gt;--%>
<%--&lt;%&ndash;                    part: 'snippet',&ndash;%&gt;--%>
<%--&lt;%&ndash;                    maxResults: 5,&ndash;%&gt;--%>
<%--&lt;%&ndash;                    id: playlist,&ndash;%&gt;--%>
<%--&lt;%&ndash;                    key: 'AIzaSyAfJQyw0LqcMkaJi0hCw35NUPyjV7Br-4g'&ndash;%&gt;--%>
<%--&lt;%&ndash;                },&ndash;%&gt;--%>

<%--&lt;%&ndash;                function (data) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                    var output;&ndash;%&gt;--%>
<%--&lt;%&ndash;                    $.each(data.items, function (i, item) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                        console.log(item);&ndash;%&gt;--%>
<%--&lt;%&ndash;                        vTitle = item.snippet.title;&ndash;%&gt;--%>
<%--&lt;%&ndash;                        vId = item.snippet.channelId;&ndash;%&gt;--%>
<%--&lt;%&ndash;                        vDe = item.snippet.description;&ndash;%&gt;--%>
<%--&lt;%&ndash;                        vTh = item.snippet.channelTitle;&ndash;%&gt;--%>
<%--&lt;%&ndash;                        vaaa = item.snippet.thumbnails.standard.url;&ndash;%&gt;--%>
<%--&lt;%&ndash;                        output = '<li>' + vTitle + '<br>--videodescription: ' + vDe + '<br>--videothumbnails: ' + vTh + '<br></li>';&ndash;%&gt;--%>
<%--&lt;%&ndash;                        /*output= '<li>'+vTitle+'<iframe src=\"//www.youtube.com/embed/'+vId+'\"></iframe></li>';*/&ndash;%&gt;--%>
<%--&lt;%&ndash;                        $("#results").append(output);&ndash;%&gt;--%>
<%--&lt;%&ndash;                    })&ndash;%&gt;--%>
<%--&lt;%&ndash;                }&ndash;%&gt;--%>
<%--&lt;%&ndash;            );&ndash;%&gt;--%>
