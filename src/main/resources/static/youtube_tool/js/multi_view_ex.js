...
function getVideoId(){
    var gvideo = $('#get_video');
    //Check video url
    if(gvideo.indexOf('youtube.com/watch?v=') == -1 && gvideo.indexOf('youtu.be/') == -1){
    ...
    var truevideoId = vid.trim();

    var linkUrl = truevideoId;
